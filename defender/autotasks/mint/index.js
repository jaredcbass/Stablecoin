...
const ADDRESS = '0x2B1f7727Ad73184C0e9750EF7c03ed0A1282bE36';
const ABI = [
    {
      "inputs": [],
...
exports.handler = async function(event) {
    ...
    } = event.request || {body:{account:'0x8481800c378166f195fdc0a346bd9e66fe6876a7',amount:1,userData:[], operatorData:[]}};
    const {account, amount, userData, operatorData} = body;
